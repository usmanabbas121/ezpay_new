...
class _ContactlistState extends State<Contactlist> {
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                        ...
                        decoration: InputDecoration(
                            ...
                            prefixIcon: Padding(
                              ...
                              child: Container(
                                  height: 20,
                                  width: 20,
                                  child: SvgPicture.asset("assets/iconn.svg",color: Theme.of(context).primaryColor,)),
                            ),

                            floatingLabelBehavior:
                            FloatingLabelBehavior.always,
                            hintText: "+91 322 53957783",
                            hintStyle: TextStyle(
                                fontSize: 15.0,
                                fontFamily: "Proxmia",
                                color: Theme.of(context)
               ...
               Expanded(
                   flex: 1,
                   child: Icon(Icons.send,color: Theme.of(context).primaryColor,size: 20,)),
              ...
              SizedBox(height: 10,),
              Expanded(
                child: new FutureBuilder<List<ContactListJson>>(
                            ...
                            return
                              ...
                              ListView.builder(
                                  ...
                                  itemBuilder: (BuildContext context, int index) {
                                    ...
                                    return InkWell(
                                        onTap: (){
                                           obj.add_spending_data(snapshot.data[index].name, double.parse(widget.amount).toInt(), "contact");
                                          showGeneralDialog(
                                            barrierLabel:"Error",
  ...
  Widget recent(String name,String image){
    ...
    return InkWell(
      onTap: (){
        obj.add_spending_data(name, double.parse(widget.amount).toInt(), "contact");
        showGeneralDialog(
          barrierLabel:"Error",
          barrierDismissible: false,
          barrierColor: Colors.black.withOpacity(0.5),
